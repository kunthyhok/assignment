...
public class ArticleByCategoryRecyclerAdapter extends RecyclerView.Adapter<ArticleByCategoryRecyclerAdapter.ArticleViewHolder>{
    private List<ArticleDataItem> news;
    private Context context;

    public ArticleByCategoryRecyclerAdapter(List<ArticleDataItem> news, Context context) {
        this.news = news;
